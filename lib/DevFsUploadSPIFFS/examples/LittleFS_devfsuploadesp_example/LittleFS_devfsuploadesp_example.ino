...
//
// ******** LittleFS on ESP32 not fully supported, so DevFsUploadESP
// ******** not implemented. Expect an error message.
// TO USE
//
// "set_SSID" and "set_SSID_password" need to be altered so
// your router may be connected too
//
...
//
// ASSUMPTION: ESP32 and/or ESP8266 libraries are installed in the IDE

/**
   DevFsUploadESP requires its libraries installed, as per
   documentation provided and the requirements of the IDE.

   DevFsUploadESP for LittleFS is install/configured into this sketch via
   the lines of code:
...
#else
#include "LittleFS.h"    // needed for LittleFS
